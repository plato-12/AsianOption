...
// indiff_accum_moments_cpp
Rcpp::List indiff_accum_moments_cpp(int N, double dt, Rcpp::NumericVector mu, double sigma, int accum_rule, int monitor_mode, Rcpp::NumericVector fix_w);
RcppExport SEXP _AsianOption_indiff_accum_moments_cpp(SEXP NSEXP, SEXP dtSEXP, SEXP muSEXP, SEXP sigmaSEXP, SEXP accum_ruleSEXP, SEXP monitor_modeSEXP, SEXP fix_wSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type N(NSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type monitor_mode(monitor_modeSEXP);
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type fix_w(fix_wSEXP);
    rcpp_result_gen = Rcpp::wrap(indiff_accum_moments_cpp(N, dt, mu, sigma, accum_rule, monitor_mode, fix_w));
    return rcpp_result_gen;
END_RCPP
}
...
Rcpp::List indiff_bellman_engine_cpp(double S0, double K, double T_mat, int N, Rcpp::NumericVector mu_vec, double sigma, double r_cont, double lambda_I, double kappa_I, Rcpp::NumericVector eta_vec, double rho, double lambda_bar_T, double lambda_bar_P, double kappa_J, double k_A, double k_B, double psi_cost, double gamma_ra, double Gamma_Q, double ell_1, double Q_bar, double eps_exec, double phi_cap, double n_opt, double I0, double Q0, double J0, Rcpp::NumericVector control_set, int n_logS, int n_I, int n_Q, int n_J, int n_R, int asian_type, int option_type, int theta, int accum_rule, int monitor_mode, Rcpp::NumericVector fix_w, double accum_sd, int grid_drift, int accum_center, bool store_policy, int n_threads, int engine_mode, bool verbose);
RcppExport SEXP _AsianOption_indiff_bellman_engine_cpp(SEXP S0SEXP, SEXP KSEXP, SEXP T_matSEXP, SEXP NSEXP, SEXP mu_vecSEXP, SEXP sigmaSEXP, SEXP r_contSEXP, SEXP lambda_ISEXP, SEXP kappa_ISEXP, SEXP eta_vecSEXP, SEXP rhoSEXP, SEXP lambda_bar_TSEXP, SEXP lambda_bar_PSEXP, SEXP kappa_JSEXP, SEXP k_ASEXP, SEXP k_BSEXP, SEXP psi_costSEXP, SEXP gamma_raSEXP, SEXP Gamma_QSEXP, SEXP ell_1SEXP, SEXP Q_barSEXP, SEXP eps_execSEXP, SEXP phi_capSEXP, SEXP n_optSEXP, SEXP I0SEXP, SEXP Q0SEXP, SEXP J0SEXP, SEXP control_setSEXP, SEXP n_logSSEXP, SEXP n_ISEXP, SEXP n_QSEXP, SEXP n_JSEXP, SEXP n_RSEXP, SEXP asian_typeSEXP, SEXP option_typeSEXP, SEXP thetaSEXP, SEXP accum_ruleSEXP, SEXP monitor_modeSEXP, SEXP fix_wSEXP, SEXP accum_sdSEXP, SEXP grid_driftSEXP, SEXP accum_centerSEXP, SEXP store_policySEXP, SEXP n_threadsSEXP, SEXP engine_modeSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type S0(S0SEXP);
    ...
    Rcpp::traits::input_parameter< double >::type ell_1(ell_1SEXP);
    Rcpp::traits::input_parameter< double >::type Q_bar(Q_barSEXP);
    Rcpp::traits::input_parameter< double >::type eps_exec(eps_execSEXP);
    Rcpp::traits::input_parameter< double >::type phi_cap(phi_capSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type accum_center(accum_centerSEXP);
    Rcpp::traits::input_parameter< bool >::type store_policy(store_policySEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_AsianOption_indiff_accum_moments_cpp", (DL_FUNC) &_AsianOption_indiff_accum_moments_cpp, 7},
    {"_AsianOption_indiff_parallel_backend_cpp", (DL_FUNC) &_AsianOption_indiff_parallel_backend_cpp, 0},
    {"_AsianOption_indiff_bellman_engine_cpp", (DL_FUNC) &_AsianOption_indiff_bellman_engine_cpp, 46},
